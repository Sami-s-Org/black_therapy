...
export default function AdminTherapists() {
  ...
  const [newTherapist, setNewTherapist] = useState<Therapist | null>(null);
  ...
  const handleAcceptTherapist = async (id: string) => {
    try {
      ...
      setTherapists((prev) =>
        prev.map((therapist) =>
          therapist.id === id ? { ...therapist, accepted: true } : therapist
        )
      );
                ...
                {paginatedTherapists.map((therapist) => (
                  <tr key={therapist.id}>
                    <td>
                      <Avatar
                        sizes="32px"
                        src={therapist.imageUrl || Avatars}
                      />
                    </td>
      ...
      {showDeleteModal && selectedTherapist && (
        <div className={styles.modalBackdrop}>
          <div className={styles.modal2}>
            <h3 style={{ color: "#131313", textAlign: "center" }}>
              Confirm Deletion
            </h3>
