    ...
    <>
      ...
      <div className={styles.privacyContainer}>
        ...
        <section>
          ...
          <p>
            We do not sell or share your data. Trusted providers may access
            minimal information strictly to support you.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            We use SSL encryption, secure data storage, and strict access
            control. While no system is 100% secure, we follow best practices to
        ...
        <section>
          <h2>Your Rights</h2>
          <p>
            You may request, update, or delete your data anytime by emailing us
            at{" "}
        ...
        <section>
          ...
          <p>
            Our site may use cookies to enhance your experience. You can control
        ...
        <section>
          <h2>Final Words</h2>
          <p>
            Your trust is sacred. Your healing journey deserves privacy,
