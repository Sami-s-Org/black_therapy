    ...
    <>
      ...
      <div className={styles.page}>
        <h1 className={styles.title}>
          Find a Therapist Who Truly Understands Your Journey
        </h1>
        <p className={styles.intro}>
          At Therapy for Black Men, we recognize that healing extends beyond
          therapy. Sometimes, you need guidance, structure, and accountability
            ...
            {filteredTherapists.length > 0 ? (
              filteredTherapists.map((therapist, index) => (
                <div key={index} className={styles.card}>
                  ...
                  <button
                    onClick={() => handleGoProfile(therapist)}
